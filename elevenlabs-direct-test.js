// Simple direct test to ElevenLabs API using node-fetch
// This bypasses the elevenlabs SDK entirely
...
async function testVoicesEndpoint() {
  ...
  try {
    // Make the request exactly according to ElevenLabs documentation
